...
+ (NSCharacterSet * _Nonnull)allowedURLCharacterSet;
@end
...
@property (nonatomic, strong) NSData * _Nullable certData;
...
@property (nonatomic, copy) NSArray<NSData *> * _Nullable certificates;
@property (nonatomic, copy) NSArray<SecKeyRef> * _Nullable pubKeys;
...
- (SecKeyRef _Nullable)extractPublicKey:(NSData * _Nonnull)data;
...
///
/// \returns  a public key
- (SecKeyRef _Nullable)extractPublicKeyFromCert:(SecCertificateRef _Nonnull)cert policy:(SecPolicyRef _Nonnull)policy;
...
- (NSArray<NSData *> * _Nonnull)certificateChainForTrust:(SecTrustRef _Nonnull)trust;
...
- (NSArray<SecKeyRef> * _Nonnull)publicKeyChainForTrust:(SecTrustRef _Nonnull)trust;
@end
...
- (void)emitAck:(NSInteger)ack withItems:(NSArray * _Nonnull)items;
- (void)engineDidClose:(NSString * _Nonnull)reason;
